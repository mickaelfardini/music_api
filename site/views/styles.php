...
<body>
	...
	<div ng-controller="Styles" class="container">

		<!-- Page Heading -->
		<h1 class="my-4">Styles
		</h1>

		<div class="row">
			<div ng-repeat="style in styles" class="col-lg-4 col-sm-6 card-item">
				<div class="card h-100">
					<a href="#"><img class="card-img-top" ng-src="{{album.cover}}" alt=""></a>
					<div class="card-body">
						<h4 class="card-title">
							<a href="/MusicAPI/MVC_Micka/styles/{{style.style}}">{{style.style}}</a>
						</h4>
